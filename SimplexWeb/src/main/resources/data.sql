...
--Document category Tbl ################################################################################
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (1, 'ALL_DOCUMENTS', 'All Documents', 1);
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (2, 'PO_DOCUMENTS', 'PO Documents', 1);
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (3, 'INVOICE_PACKING_LIST', 'Invoice & Packing List', 1);
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (4, 'BL_DOCUMENTS', 'BL Documents', 1);
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (5, 'CERTIFICATE_DOCUMENTS', 'Certificates', 1);
INSERT INTO `simplex_db`.`document_category_tbl` (`document_category_id`, `document_category_abbr`, `document_category_name`, `is_active`) VALUES (6, 'OTHER_DOCUMENTS', 'Other', 1);
